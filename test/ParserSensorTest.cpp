...
TEST(ParseSensor, sensor_yaml) {
  ...
  isSensor = se.match(
      [](empty<Sensors>) -> unsigned int { return 0; },
      [](missing<Sensors>) -> unsigned int { return 1; },
      [](Sensors sen) -> unsigned int { return 2; },
...
//       },
//       [](missing<KaCanOpenUsbOptions>) -> std::pair<unsigned int,
//       std::string> {
//         return std::make_pair(4, "");
//       },
//       [](invalid<KaCanOpenUsbOptions>) -> std::pair<unsigned int,
//       std::string> {
